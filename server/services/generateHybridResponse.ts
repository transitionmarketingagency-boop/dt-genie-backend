...
/* ================= VECTOR KNOWLEDGE (Legacy + Latest Fusion) ================= */
...
Provide a clear, helpful answer aligned with the conversation stage, lead potential, and detected intent.
`;
